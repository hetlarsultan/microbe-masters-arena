...
export const CASES: Case[] = [
  ...
  {
    id: "c11", branch: "hematology", emoji: "🩸",
    patient: "امرأة 32 سنة",
    history: "تعب وشحوب وضيق نفس عند المجهود منذ شهرين مع غزارة الطمث",
    symptoms: ["شحوب", "تعب", "تساقط شعر", "هشاشة أظافر"],
    specimen: "EDTA دم وريدي (أنبوب أرجواني)",
    tests: [
      { id: "cbc", name: "CBC (تعداد دم كامل)", result: "Hb 8.2 g/dL — MCV 68 fL — MCH 22 pg" },
      { id: "smear", name: "مسحة دم محيطية", result: "كريات صغيرة شاحبة (Microcytic Hypochromic)" },
      { id: "ferritin", name: "Serum Ferritin", result: "8 ng/mL (منخفض جداً)" },
    ],
    options: ["أنيميا نقص الحديد", "ثلاسيميا β", "أنيميا الأمراض المزمنة", "أنيميا انحلالية"],
    answer: "أنيميا نقص الحديد",
    treatment: "Ferrous sulfate فموياً 3–6 أشهر + علاج سبب النزف",
    explanation: "MCV منخفض مع فيريتين منخفض = نقص حديد. غزارة الطمث سبب شائع عند النساء.",
  },
  {
    id: "c12", branch: "hematology", emoji: "🧬",
    patient: "رجل 58 سنة",
    history: "تعب وفقدان وزن وتضخم طحال كبير منذ 4 أشهر",
    symptoms: ["تضخم طحال", "تعرق ليلي", "فقدان وزن"],
    specimen: "دم محيطي + نخاع عظمي",
    tests: [
      { id: "wbc", name: "WBC", result: "180,000/µL مع جميع مراحل النضج النخاعي" },
      { id: "phil", name: "كروموسوم فيلادلفيا (FISH)", result: "إيجابي t(9;22) BCR-ABL" },
    ],
    options: ["CML", "AML", "CLL", "ALL"],
    answer: "CML",
    treatment: "Imatinib (مثبط تيروزين كيناز)",
    explanation: "ابيضاض الدم النقوي المزمن يتميز بـ BCR-ABL وتعداد كريات بيضاء مرتفع جداً مع جميع مراحل النضج.",
  },
  {
    id: "c13", branch: "biochemistry", emoji: "🫀",
    patient: "رجل 55 سنة",
    history: "ألم صدري ضاغط منذ 3 ساعات مع تعرق وغثيان",
    symptoms: ["ألم صدري", "تعرق", "ضيق نفس"],
    specimen: "مصل (أنبوب أصفر SST)",
    tests: [
      { id: "trop", name: "Troponin I", result: "12.5 ng/mL (مرتفع جداً)" },
      { id: "ck", name: "CK-MB", result: "45 U/L (مرتفع)" },
      { id: "ecg", name: "ECG", result: "ارتفاع ST في II, III, aVF" },
    ],
    options: ["احتشاء عضلة القلب الحاد STEMI", "ذبحة صدرية مستقرة", "التهاب التامور", "انسداد رئوي"],
    answer: "احتشاء عضلة القلب الحاد STEMI",
    treatment: "PCI طارئ + Aspirin + Heparin",
    explanation: "ارتفاع Troponin مع تغيرات ST يؤكد الاحتشاء. تروبونين هو المعيار الذهبي.",
  },
  {
    id: "c14", branch: "biochemistry", emoji: "🟡",
    patient: "رجل 48 سنة",
    history: "اصفرار الجلد والعينين وبول داكن بعد تناول كحول مزمن",
    symptoms: ["يرقان", "استسقاء", "تعب"],
    specimen: "مصل",
    tests: [
      { id: "alt", name: "ALT / AST", result: "ALT 85 — AST 220 (AST/ALT > 2)" },
      { id: "bili", name: "Bilirubin", result: "Total 6.2 — Direct 4.8 mg/dL" },
      { id: "alb", name: "Albumin", result: "2.6 g/dL (منخفض)" },
      { id: "inr", name: "INR", result: "1.8 (مطوّل)" },
    ],
    options: ["تليف كبدي كحولي", "التهاب كبد فيروسي حاد", "ركود صفراوي خارج كبدي", "متلازمة جيلبرت"],
    answer: "تليف كبدي كحولي",
    treatment: "إيقاف الكحول + دعم غذائي + Spironolactone للاستسقاء",
    explanation: "AST/ALT > 2 مع نقص ألبومين وارتفاع INR نمط مميز للأذى الكبدي الكحولي المزمن.",
  },
  {
    id: "c15", branch: "biochemistry", emoji: "🍬",
    patient: "امرأة 60 سنة",
    history: "عطش وتبول متكرر وفقدان وزن منذ 3 أشهر",
    symptoms: ["عطش", "تبول كثير", "تعب", "تشوش رؤية"],
    specimen: "مصل + بول",
    tests: [
      { id: "fbs", name: "سكر صائم", result: "186 mg/dL" },
      { id: "hba1c", name: "HbA1c", result: "9.4%" },
      { id: "urine", name: "تحليل بول", result: "جلوكوز ++ بدون كيتونات" },
    ],
    options: ["داء السكري النوع 2", "داء السكري النوع 1", "السكري الكاذب", "متلازمة كوشينغ"],
    answer: "داء السكري النوع 2",
    treatment: "Metformin + تعديل نمط الحياة",
    explanation: "HbA1c ≥ 6.5% أو سكر صائم ≥ 126 mg/dL مرتين يشخص السكري. غياب الكيتونات يرجح النوع 2.",
  },
];
